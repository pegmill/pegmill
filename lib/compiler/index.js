...
var compiler = {
  ...
  passes: {
    ...
    transform: {
      instantiateTemplates:             require("./passes/instantiate-templates"),
      removeNonInstantiatedTemplates:   require("./passes/remove-non-instantiated-templates"),
    ...
    generate: {
      ...
      generateWASM:             require("./passes/generate-wasm")
    }
  },
